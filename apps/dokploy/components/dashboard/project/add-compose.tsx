...
export const AddCompose = ({ projectId, projectName }: Props) => {
  ...
  const { mutateAsync, isLoading, error, isError } = api.compose.create.useMutation();
    ...
    <Dialog open={visible} onOpenChange={setVisible}>
      ...
      <DialogContent className='sm:max-w-xl'>
        <DialogHeader>
          ...
          <DialogDescription>{t('dashboard.compose.assignNameAndDescription')}</DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('dashboard.compose.appNamePlaceholder')} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder={t('dashboard.compose.selectComposeType')} />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      <SelectItem value='docker-compose'>{t('dashboard.compose.dockerCompose')}</SelectItem>
                      <SelectItem value='stack'>{t('dashboard.compose.stack')}</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder={t('dashboard.compose.descriptionPlaceholder')}
